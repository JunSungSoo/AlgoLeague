...
import { Alert, Box, Field, Heading, Link, Text } from "@chakra-ui/react";
...
export default function ResetPasswordPage() {
    ...
    return (
        <AuthFrame mode="login">
            ...
            {done ? (
                    ...
                    <Alert.Content>
                        ...
                        <Alert.Description>
                            <Link asChild color="accent">
                                <NextLink href={ROUTES.LOGIN}>새 비밀번호로 로그인하기</NextLink>
                            </Link>
                        </Alert.Description>
                    </Alert.Content>
                </Alert.Root>
                ...
                <Box mt="32px">
                    ...
                    <Field.Root required mt="18px">
                        ...
                        <FlexLayout direction={{ base: "column", sm: "row" }} gap="8px">
                            <AppInput
                                inputMode="tel"
                                autoComplete="tel"
            ...
            <FlexLayout mt="28px" justify="center" fontSize="12px">
                <Link asChild color="accent">
